# scafctl-plugin-metadata - AI Agent Instructions

## Overview

scafctl provider plugin implementing the **metadata** provider.

## Key Patterns

- **Plugin SDK**: Uses `github.com/oakwood-commons/scafctl-plugin-sdk`
- **Entry point**: `cmd/scafctl-plugin-metadata/main.go` calls `sdkplugin.Serve()`
